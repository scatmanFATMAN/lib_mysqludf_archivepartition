...
install: $(lib)
	...
	@mysql -u $(USER) -p -e "CREATE OR REPLACE FUNCTION move_partition RETURNS string SONAME '$(lib)'; CREATE OR REPLACE FUNCTION drop_partition RETURNS string SONAME '$(lib)';"
